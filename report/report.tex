...
States: 
  \begin{itemize}
    \item At an intersection with a red light
    \item At an intersection with a green light
    \item At an intersection with oncoming traffic
    \item When the smartcab is stationary
    \item When the smartcab is moving
    \item When the smartcab is turning left
    \item When the smartcab is turning right
...
\centering
    ...
    \caption{\textbf{Agent State: Unobstructed}}\label{fig:state1}
\end{figure}
